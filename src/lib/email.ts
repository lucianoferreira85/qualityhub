      ...
      html: `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
          ...
          <div style="background: #ffffff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 32px;">
            <h2 style="color: #1a1a1a; font-size: 20px; margin: 0 0 16px;">Voce foi convidado!</h2>
            <p style="color: #616161; font-size: 14px; line-height: 1.6; margin: 0 0 8px;">
              <strong>${inviterName}</strong> convidou voce para participar de <strong>${tenantName}</strong> como <strong>${roleLabel}</strong>.
            </p>
            <p style="color: #616161; font-size: 14px; line-height: 1.6; margin: 0 0 24px;">
              Clique no botao abaixo para aceitar o convite e criar sua conta (ou fazer login).
            </p>
            ...
            <p style="color: #8a8886; font-size: 12px; line-height: 1.5; margin: 0;">
              Este convite expira em 7 dias. Se voce nao esperava este email, pode ignora-lo com seguranca.
            </p>
          </div>
          <p style="text-align: center; color: #8a8886; font-size: 12px; margin-top: 24px;">
            QualityHub — Sistema de Gestao da Qualidade
          </p>
        </div>
      `,
    });
